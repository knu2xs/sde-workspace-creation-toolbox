...
# get local machine name to be used by multiple tools
...
class createSde(object):
    ...
    def getParameterInfo(self):
        ...
        param1.value=localInstance # instance
        param2.value='PostgreSQL' # dbms
        param4.value='Esri12345678' # su password
        param5.value='Esri$tud' # sde password
        param6.value='owner' # data owner username
        param7.value='Esri$tud' # data owner password
        # authorization file
        param8.value=r'C:\Program Files\ESRI\License10.1\sysgen\keycodes'
    ...
    def createSdeExecute(self, parameters):
        ...
        authFile=parameters[8].valueAsText
        ...
        try:
            ...
            arcpy.AddMessage('Unable to connect as sde.')
            arcpy.AddMessage(arcpy.GetMessages())
    ...
    def execute(self, parameters, messages):
        ...
        self.createSdeExecute(parameters)
